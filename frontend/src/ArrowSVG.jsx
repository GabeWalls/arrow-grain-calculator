      ...
      >
        ...
        <defs>
          ...
          >
            ...
            <feFlood floodColor="#39ff14" floodOpacity="1" />
        ...
        {/* Shaft */}
        <rect
          className={`${isActive('shaft') ? 'fill-[#39ff14]' : 'fill-gray-300'} cursor-pointer transition-all duration-200 hover:fill-[#39ff14] hover:-translate-y-1`}
        ...
        >
          <path className={`transition-all duration-200 ${shouldGlow('fletching') ? 'fill-[#39ff14]' : 'fill-gray-300'}`} d="M124.22,35.69s15.86-29.46,40.79-27.65c0,0,139.92,8.39,167.19,27.65H124.22Z"/>
          <path className={`transition-all duration-200 ${shouldGlow('fletching') ? 'fill-[#39ff14]' : 'fill-gray-300'}`} d="M124.22,79.03s15.86,30.31,40.79,28.45c0,0,139.92-8.63,167.19-28.45H124.22Z"/>
        </g>

        {/* Knock */}
        <path
          className={`${isActive('knock') ? 'fill-[#39ff14]' : 'fill-gray-300'} cursor-pointer transition-all duration-200 hover:fill-[#39ff14] hover:-translate-y-1`}
        ...
        >
          <path
            className={`transition-all duration-200 ${shouldGlow('tip') ? 'fill-[#39ff14]' : 'fill-gray-300'}`}
            d="M893.88,24.3s-4.19,5.33-21.84,22.51c-.37-.25-.81-.4-1.3-.4h-18.23c-1.26,0-2.29,1.02-2.29,2.29v18.23c0,1.26,1.02,2.29,2.29,2.29h18.23c.71,0,1.34-.33,1.76-.84,17.25,16.81,21.37,22.04,21.37,22.04l-0,0l80.31-26.77h20.14v-12.54h-20.14l-80.31-26.79ZM900.67,76.92l-7.87-11.15h45.79l-37.93,11.15ZM892.81,48.96l7.87-11.16,37.93,11.16h-45.79Z"
          />
          <polygon
            className={`transition-all duration-200 ${shouldGlow('tip') ? 'fill-[#39ff14]' : 'fill-gray-300'}`}
        ...
        {/* Insert */}
        <rect
          className={`${isActive('insert') ? 'fill-[#39ff14]' : 'fill-gray-300'} cursor-pointer transition-all duration-200 hover:fill-[#39ff14] hover:-translate-y-1`}
