    ...
    return (
      <div className="relative mb-10 flex justify-center">
        ...
        >
          ...
          {/* Shaft */}
          <rect
            className={`${hot('shaft') ? 'fill-orange-500' : 'fill-gray-300'} cursor-pointer transition-transform duration-200 hover:fill-orange-500 hover:-translate-y-1`}
          ...
          >
            <path
              className={`transition-colors duration-200 ${hot('fletching') ? 'fill-orange-500' : 'fill-gray-300'}`}
          ...
          {/* Knock */}
          <path
            className={`${hot('knock') ? 'fill-orange-500' : 'fill-gray-300'} cursor-pointer transition-transform duration-200 hover:fill-orange-500 hover:-translate-y-1`}
          ...
          >
            <path
              className={`transition-colors duration-200 ${hot('tip') ? 'fill-orange-500' : 'fill-gray-300'}`}
          ...
          {/* Insert */}
          <rect
            className={`${hot('insert') ? 'fill-orange-500' : 'fill-gray-300'} cursor-pointer transition-transform duration-200 hover:fill-orange-500 hover:-translate-y-1`}
  ...
  return (
    <div className="relative mb-10">
      ...
      >
        ...
        {/* Shaft */}
        <rect
          className={`${activePart === 'shaft' ? 'fill-green-400' : 'fill-gray-300'} cursor-pointer transition-transform duration-200 hover:fill-green-400 hover:-translate-y-1`}
        ...
        >
          <path
            className={`transition-colors duration-200 ${hot('fletching') ? 'fill-green-400' : 'fill-gray-300'}`}
        ...
        {/* Knock */}
        <path
          className={`${hot('knock') ? 'fill-green-400' : 'fill-gray-300'} cursor-pointer transition-transform duration-200 hover:fill-green-400 hover:-translate-y-1`}
        ...
        >
          <path
            className={`transition-colors duration-200 ${hot('tip') ? 'fill-green-400' : 'fill-gray-300'}`}
        ...
        {/* Insert */}
        <rect
          className={`${hot('insert') ? 'fill-green-400' : 'fill-gray-300'} cursor-pointer transition-transform duration-200 hover:fill-green-400 hover:-translate-y-1`}
