    ...
    <div className="flex flex-col items-center w-full">
        ...
        <div className="w-full flex flex-row md:flex-col items-center md:items-center gap-4 md:gap-0 mb-4 md:mb-0 relative">
          ...
          <form onSubmit={handleSubmit} className="flex-1 md:w-full max-w-5xl grid grid-cols-1 md:grid-cols-5 gap-3 md:gap-4 md:mt-6 flex flex-col relative md:relative z-20 md:z-auto">
            ...
            <div className="flex flex-col items-start md:items-center order-1 md:order-1">
              <label className={`mb-1 transition-colors duration-200 text-base md:text-base ${activePart === 'knock' ? 'text-blaze font-bold' : ''}`}>Knock</label>
              <input type="number" name="knock" value={components.knock} onChange={handleChange} onFocus={handleInputFocus}
                     className={`bg-white dark:bg-gray-800 border px-4 py-3 md:px-2 md:py-1 rounded shadow w-full transition-all duration-200 text-lg md:text-sm ${
                       activePart === 'knock'
            ...
            <div className="flex flex-col items-start md:items-center order-2 md:order-2">
              <label className={`mb-1 transition-colors duration-200 text-base md:text-base ${activePart === 'fletching' ? 'text-blaze font-bold' : ''}`}>Vanes</label>
              ...
              <label className="mt-2 mb-1 text-sm md:text-sm">Number of Vanes</label>
              <select value={fletchCount} onChange={(e) => setFletchCount(e.target.value)}
                      className="bg-white dark:bg-gray-800 text-gray-900 dark:text-white border border-gray-300 dark:border-gray-600 px-4 py-3 md:px-2 md:py-1 rounded shadow w-full text-lg md:text-base">
            ...
            <div className="flex flex-col items-start md:items-center order-3 md:order-3">
              <label className={`mb-1 text-left md:text-center transition-colors duration-200 text-base md:text-base ${activePart === 'shaft' ? 'text-blaze font-bold' : ''}`}>Shaft (Grains Per Inch)</label>
              ...
              <label className={`mt-2 mb-1 text-sm md:text-sm text-left md:text-center transition-colors duration-200 ${activePart === 'shaft' ? 'text-blaze font-bold' : ''}`}>
              ...
              <select name="arrowLength" value={arrowLength} onChange={(e) => setArrowLength(e.target.value)} onFocus={handleInputFocus}
                      className={`bg-white dark:bg-gray-800 border px-4 py-3 md:px-2 md:py-1 rounded shadow w-full transition-all duration-200 text-lg md:text-base ${
                        activePart === 'shaft'
                          ? 'border-blaze border-2 text-gray-900 dark:text-white'
                          : 'text-gray-900 dark:text-white border-gray-300 dark:border-gray-600'
                      }`}>
              ...
              <label className="mt-2 mb-1 text-sm md:text-sm text-left md:text-center">Shaft (Total Grains)</label>
              <input type="number" value={shaftGrains} readOnly
                     className="bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white border border-gray-300 dark:border-gray-700 px-4 py-3 md:px-2 md:py-1 rounded shadow w-full text-lg md:text-sm" />
            </div>

            <div className="flex flex-col items-start md:items-center order-4 md:order-4">
              <label className={`mb-1 transition-colors duration-200 text-base md:text-base ${activePart === 'insert' ? 'text-blaze font-bold' : ''}`}>Insert</label>
            ...
            <div className="flex flex-col items-start md:items-center order-5 md:order-5">
              <label className={`mb-1 transition-colors duration-200 text-base md:text-base ${activePart === 'tip' ? 'text-blaze font-bold' : ''}`}>Broadhead</label>
      ...
      <div className="col-span-1 md:col-span-5 flex flex-col items-center mt-4 md:mt-6 w-full max-w-md mx-auto px-4">
        <input type="text" placeholder="Build Name" value={buildName} onChange={(e) => setBuildName(e.target.value)}
               className="bg-white dark:bg-gray-800 text-gray-900 dark:text-white border border-gray-300 dark:border-gray-600 px-4 py-3 md:px-2 md:py-1 rounded shadow w-full mb-2 text-lg md:text-sm" />
        <div className="w-full mb-2">
          <label className="block mb-1 text-base md:text-sm font-medium text-gray-700 dark:text-gray-300">Target Animal</label>
          <select 
            value={animal} 
            onChange={(e) => setAnimal(e.target.value)}
            className="bg-white dark:bg-gray-800 text-gray-900 dark:text-white border border-gray-300 dark:border-gray-600 px-4 py-3 md:px-2 md:py-1 rounded shadow w-full text-lg md:text-sm"
          >
            {ANIMALS.map(a => (
