  ...
  return (
    <div className="relative mb-10">
      ...
      >
        ...
        >
          <path
            className={`transition-all duration-200 ${shouldGlow('fletching') ? 'fill-green-300' : 'fill-gray-300'} hover:-translate-y-1`}
        ...
        {/* Tip (group-level glow on hover/active) */}
        <g
          pointerEvents="bounding-box"
          className="cursor-pointer transition-all"
        ...
        >
          <path
            className={`transition-all duration-200 ${shouldGlow('tip') ? 'fill-green-300' : 'fill-gray-300'} hover:-translate-y-1`}
